    ...
    return (
        <div className="min-h-screen pb-20 px-4 sm:px-6 lg:px-8 max-w-screen-2xl mx-auto text-center">
            <section className="relative flex flex-col items-center pt-56 gap-4 pb-16">
                ...
                <div className="flex flex-col gap-14 pt-24 max-w-xl w-full text-center">
                    {importantInfo.map((info) => (
                        <div key={info?.title}>
                            ...
                            {'ceremony' in info && (
                                <div>
                                    <h3 className="text-2xl font-lora mb-2">
                                        Ceremony
                                    </h3>
                                    <p className="font-lora leading-relaxed">
                                        {info.ceremony.info}
                                    </p>
                                    <p className="font-lora leading-relaxed pt-8">
                                        {info.ceremony.additionalInfo}
                                    </p>
                                </div>
                            )}
                            {'reception' in info && (
                            ...
                            {'taxis' in info && (
                                <div>
                                    <ul className="list-inside font-lora leading-relaxed">
                                        {info.taxis.map((taxi) => (
                                            <li key={taxi.name}>
